...
public class User implements Serializable {
    ...
    @Pattern(regexp = "^[\\p{L}_0-9]{2,}$", message = "Username contains not allowed characters (\\, /, :, *, ?, \", <, >, |)")
    @Length(min = 2, max = 30, message = "Username must be at least 2 and max 20 characters long")
